...
export const ManagerAnalytics = () => {
    ...
    return (
        <div className="m-10 lg:ml-96 sm:ml-auto md-ml-60">
            ...
            <div className="bg-slate-100 mt-4 p-4 flex flex-col space-y-4 rounded-md">
                ...
                <div className="flex space-x-4 mt-4 justify-center items-center w-full">
                    ...
                    <div className="bg-white rounded-md w-44 h-44 flex flex-col items-center justify-center shadow-sm">
                        ...
                        <span className="text-3xl font-bold text-mediumPurple"><Animation n={noOfNewProjects} /></span>
                    </div>
                    
                    {/* Second container */}
                    <div className="bg-white rounded-md w-44 h-44 flex flex-col items-center justify-center shadow-sm">
                        <h4 className="text-base font-medium mb-4">In Progress</h4>
                        <span className="text-3xl font-bold text-mediumPurple"><Animation n={noOfInProgressProjects} /></span>
                    </div>
                    
                    {/* Third container */}
                    <div className="bg-white rounded-md w-44 h-44 flex flex-col items-center justify-center shadow-sm">
                        <h4 className="text-base font-medium mb-4 ">Completed Projects</h4>
                        <span className="text-3xl font-bold text-mediumPurple"><Animation n={noOfCompletedProjects} /></span>
                    </div>
                </div>
            </div>
